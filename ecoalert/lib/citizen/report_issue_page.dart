...
class _ReportIssuePageState extends State<ReportIssuePage> {
  ...
  final categories = [
    {"title": "waste", "icon": Icons.delete_outline},

    {"title": "drainage", "icon": Icons.water_drop_outlined},

    {"title": "pollution", "icon": Icons.air},

    {"title": "electrical", "icon": Icons.electrical_services_outlined},

    {"title": "plumbing", "icon": Icons.plumbing_outlined},

    {"title": "complaint", "icon": Icons.warning_amber_outlined},
